        ...
        <View className="mx-4 pt-6">
          ...
          <View className="justify-center items-center">
            ...
            <View className="py-5">
              ...
              >
                Press <Text style={{ color: "#FC5750" }}>SOS</Text> for help
              </Text>
            </View>
          </View>
          <View className="mt-8">
            <View className="flex-row justify-center items-center -ml-1">
              ...
              <Text
                className="text-2xl pl-3 font-semibold text-white"
                style={{ fontFamily: "Barlow_medium" }}
              >
                Send only your location
              </Text>
            </View>
            <View className="justify-end items-center py-3">
              <Text
                className="text-white text-md w-3/4 pl-10"
                style={{ fontFamily: "Barlow_medium" }}
              >
                SOS mode will send the location to your friends, family & local
                Police
              </Text>
            </View>
          </View>
